### Using array method .filter create function filterWith that will search for phrase or number in given array of objects

- [ ] should search for phrase in all nested levels of arrays and objects
...
// if phrase length is shorter than 3 return empty array
// if phrase length is equal to 3 and longer it should filter every string and number values in object

function filterWith(arr, phrase) {
  // ...
  // return result;
}
// first argument is array of objects and second phrase to be found
filterWith(data, "Cummings Baxter");
// function returns an array with object that contains phrase being searched for
const result = [
  {
    _id: "5e985a07feddae7617ac44f6",
    age: 24,
